...
<div class="flex flex-wrap gap-4 mb-10">
    ...
    <a href="/"
        ...
        hover:scale-105 hover:shadow-indigo-300
...
<section class="max-w-7xl mx-auto px-6 py-24">
    ...
    <div class="text-center mb-16">
        ...
        <span
            class="inline-block px-5 py-2 bg-indigo-100 text-indigo-600 rounded-full text-sm font-bold uppercase tracking-wider mb-5">

            Trusted Partners

        </span>

        <h2 class="text-3xl md:text-5xl font-extrabold text-slate-800 leading-tight mb-5">
        ...
        <p class="text-slate-500 text-lg max-w-2xl mx-auto leading-relaxed">
            ...
            Berkolaborasi bersama berbagai perusahaan dan brand terpercaya
...
<div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
    ...
    <div
        class="group bg-white rounded-3xl border border-slate-100 p-8 shadow-sm hover:shadow-2xl hover:-translate-y-2 transition-all duration-300">

        <!-- Logo -->
        <div class="w-full h-24 flex items-center justify-center mb-6">

            <img
                src="{{ $partner->logo_url }}"
                alt="{{ $partner->name }}"
                class="max-h-16 object-contain group-hover:scale-105 transition duration-300">

        </div>

        <!-- Nama -->
        <h3 class="text-xl font-bold text-slate-800 text-center mb-3 group-hover:text-indigo-600 transition">
        ...
        <div class="flex justify-center mb-4">
            ...
            <span
                class="px-4 py-1 bg-indigo-50 text-indigo-600 rounded-full text-xs font-semibold uppercase tracking-wide">
